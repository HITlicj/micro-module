...
export default class MicroModule extends React.Component<any, State> {
  ...
  private moduleInfo: StarkModule | null = null;
  ...
  componentWillUnmount() {
    try {
      ...
      console.error('[MicroModule] error occurred when unmount module', error);
    }
  }
  ...
  getModuleInfo() {
    ...
    if (!this.moduleInfo) {
      console.error(`[MicroModule] Can't find ${this.props.moduleName} module in modules config`);
    }
  }
  ...
  validateRender() {
    ...
    if (render && typeof render !== 'function') {
      console.error('[MicroModule]: render should be funtion');
    }
