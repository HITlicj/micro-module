import Sandbox, { SandboxProps, SandboxConstructor } from '@atom-web/sandbox';
...
export const getImportedModule = function (name: string) {
  if (typeof name !== 'string') {
    console.error(`[MicroModule]: should be string, but get ${typeof name}`);
    return;
  }
...
export const loadModule = async (targetModule: StarkModule, sandbox?: ISandbox) => {
  ...
  if (!mount || !unmount) {
    console.error('[MicroModule] Please export mount/unmount function');
  }
